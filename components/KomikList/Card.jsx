...
// Testing
const Card = ({ api, banyakData, title }) => {
  return (
    <section className="w-full py-12">
      <div className="container grid grid-cols-2 gap-12 px-4 md:px-6 mb-4">
      ...
      <div className="container grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-4 md:px-6 drop-shadow-lg">
        {api.data.slice(0, banyakData).map((data, index) => {
          return (
            <div
              className="relative group overflow-hidden rounded-lg md:basis-1/2 "
              key={index}
            >
